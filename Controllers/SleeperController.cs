...
namespace DynastyRanker.Controllers
{
    public class SleeperController : Controller
    {
        ...
        public static readonly String LEAGUEYEAR = "2023";
        ...
        {
            HttpClient client = new HttpClient();
            HttpResponseMessage response = await client.GetAsync("https://api.sleeper.app/v1/user/" + userID + "/leagues/nfl/" + LEAGUEYEAR);
            response.EnsureSuccessStatusCode();
            string responseBody = await response.Content.ReadAsStringAsync();
        ...
        public void ScrapeRankings(string previousScrapeDate)
        {
            ...
            if (true)
            {
                ...
                foreach (var p in nameList)
                {
                    ...
                    if (tempName.Contains("2025") && tempName.Contains("1st"))
                        avg2025First += Convert.ToInt32(tempValue);
                    if (tempName.Contains("2025") && tempName.Contains("2nd"))
                        avg2025Second += Convert.ToInt32(tempValue);
                    if (tempName.Contains("2025") && tempName.Contains("3rd"))
                        avg2025Third += Convert.ToInt32(tempValue);
                    if (tempName.Contains("2025") && tempName.Contains("4th"))
                        avg2025Fourth += Convert.ToInt32(tempValue);
                ...
                newKtc = new Player();
                avg2025First = avg2025First / 3;
                newKtc.Name = "2025 1st";
                newKtc.Value = Convert.ToString(avg2025First);
                newKtc.Position = "PI";
                newKtc.Team = "NA";
                newKtc.IsRookie = "NA";
                ktcList.Add(newKtc);
                ...
                newKtc = new Player();
                avg2025Second = avg2025Second / 3;
                newKtc.Name = "2025 2nd";
                newKtc.Value = Convert.ToString(avg2025Second);
                newKtc.Position = "PI";
                newKtc.Team = "NA";
                newKtc.IsRookie = "NA";
                ktcList.Add(newKtc);
                ...
                newKtc = new Player();
                avg2025Third = avg2025Third / 3;
                newKtc.Name = "2025 3rd";
                newKtc.Value = Convert.ToString(avg2025Third);
                newKtc.Position = "PI";
                newKtc.Team = "NA";
                newKtc.IsRookie = "NA";
                ktcList.Add(newKtc);
                ...
                newKtc = new Player();
                avg2025Fourth = avg2025Fourth / 3;
                newKtc.Name = "2025 4th";
                newKtc.Value = Convert.ToString(avg2025Fourth);
                newKtc.Position = "PI";
                newKtc.Team = "NA";
                newKtc.IsRookie = "NA";
                ktcList.Add(newKtc);
        ...
        public void ScrapeSFRankings(string previousScrapeDate)
        {
            ...
            if (true)
            {
                ...
                newKtc = new Player();
                avg2025First = avg2025First / 3;
                //avg2025First = Math.Truncate(avg2025First);
                newKtc.Name = "2025 1st";
                newKtc.Value = Convert.ToString(avg2025First);
                newKtc.Position = "PI";
                newKtc.Team = "NA";
                ...
                newKtc = new Player();
                avg2025Second = avg2025Second / 3;
                //avg2025Second = Math.Truncate(avg2025Second);
                newKtc.Name = "2025 2nd";
                newKtc.Value = Convert.ToString(avg2025Second);
                newKtc.Position = "PI";
                newKtc.Team = "NA";
                ...
                newKtc = new Player();
                avg2025Third = avg2025Third / 3;
                //avg2025Third = Math.Truncate(avg2025Third);
                newKtc.Name = "2025 3rd";
                newKtc.Value = Convert.ToString(avg2025Third);
                newKtc.Position = "PI";
                newKtc.Team = "NA";
                ...
                newKtc = new Player();
                avg2025Fourth = avg2025Fourth / 3;
                //avg2025Fourth = Math.Truncate(avg2025Fourth);
                newKtc.Name = "2025 4th";
                newKtc.Value = Convert.ToString(avg2025Fourth);
                newKtc.Position = "PI";
                newKtc.Team = "NA";
        ...
        public void AddDraftPositionToRoster(Draft draft, List<Rosters> rosters)
        {
            ...
            foreach (Rosters ros in rosters)
            {
                ...
                if (draft.Rounds >= 4)
                {
                    ...
                    startingDraftPicks.Add("2024 2nd");
                    startingDraftPicks.Add("2024 3rd");
                    startingDraftPicks.Add("2024 4th");
                    startingDraftPicks.Add("2025 1st");
                    startingDraftPicks.Add("2025 2nd");
                    startingDraftPicks.Add("2025 3rd");
                    startingDraftPicks.Add("2025 4th");
                }
        ...
        public List<Rosters> TradedDraftPicks(List<Rosters> rosters, List<TradedPick> tp, Draft draft)
        {
            ...
            foreach (var trade in tp)
            {
                ...
                if (trade.Season == "2023" || trade.Season == "2024" || trade.Season == "2025")
                {
                    ...
                    //if (draft.Status == "complete" && trade.Season == "2023")
                    //    continue;
